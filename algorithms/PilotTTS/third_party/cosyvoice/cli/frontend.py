...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        # NOTE: speech_tokenizer_session uses CPUExecutionProvider even when CUDA is available,
        # because ONNX Runtime's CUDA provider initialisation can corrupt the CUDA context on
        # some driver/lib setups (cudaSetDevice(-1) → CUDA error 999), breaking PyTorch GPU ops
        # that follow. The speech tokenizer is a small encoder that runs fine on CPU.
